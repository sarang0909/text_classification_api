...
SHELL ["conda", "run", "-n", "text_classification_api", "/bin/bash", "-c"]
...
ENTRYPOINT ["conda", "run", "--no-capture-output", "-n", "text_classification_api", "uvicorn", "main:app", "--host", "0.0.0.0", "--port", "5000"]